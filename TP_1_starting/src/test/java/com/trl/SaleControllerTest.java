...
public class SaleControllerTest 
{
	...
	{
		saleController = new SaleController(dataStore);
	...
	public void testStartTransaction()  
	{
		...
		try 
		{
			returnResult = saleController.startTransaction(null);
		} 
	...
	public boolean startTranscation(Patron patron)
	{
		...
		try 
		{
			returnResult = saleController.startTransaction(patronTransacted);
		} 
		catch (TransactionAlreadyInProgress e) 
		{
			//not expected
	...
	public void testEndTransaction()  
	{
		...
		try 
		{
			returnResult = saleController.endTransaction(patronTransacted);
		} 
